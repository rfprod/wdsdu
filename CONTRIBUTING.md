...
Check out the [existing issues](https://github.com/rfprod/wdsdu/issues) and see what [types of contributions](#types-of-contributions) are accepted.

### Don't see your issue? Open one

If you spot something new, open an issue using a [template](https://github.com/rfprod/wdsdu/issues/new/choose). We'll use the issue to have a conversation about the problem you want to fix.
...
If you've found something in the content or the website that should be updated, search open issues to see if someone else has reported the same thing. If it's something new, open an issue using a [template](https://github.com/rfprod/wdsdu/issues/new/choose). We'll use the issue to have a conversation about the problem you want to fix.
...
You can browse [existing issues](https://github.com/rfprod/wdsdu/issues) to find something that needs help.

If you find something that is not present in the issues section [Submit a new issue using existing templates](https://github.com/rfprod/wdsdu/issues/new/choose)
...
Check all available labels with description [here](https://github.com/rfprod/wdsdu/labels).
...
Once your PR is merged, you will be listed as a contributor in the [contributor chart](https://github.com/rfprod/wdsdu/graphs/contributors).
...
To work with in the repository the following [requirements](https://github.com/rfprod/wdsdu#requirements) should be fulfilled.
